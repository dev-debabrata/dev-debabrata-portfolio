...
const ThemeToggler = () => {
    ...
    return (
        <button
            onClick={toggleTheme}
            className="relative w-9 h-9 md:w-10 md:h-10 lg:w-10 lg:h-10 xl:w-10 xl:h-10 flex items-center justify-center rounded-full border dark:border-gray-400 border-blue-400 hover:text-white hover:bg-blue-800 dark:hover:bg-white dark:hover:text-black transition"
