...
const Navbar = () => {
    ...
    return (
        <nav className={`fixed top-0 w-full z-999 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[10vw] ${isScrolled ? "bg-[#8d8d9920] dark:bg-[#0000006d] dark:text-gray-50 text-whi bg-opacity-50 backdrop-blur-md shadow-xl" : " text-gray-900 dark:bg-slate-950 dark:text-gray-100"
            } `}>
